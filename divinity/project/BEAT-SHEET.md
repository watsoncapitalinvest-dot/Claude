# DIVINITY
### Full beat sheet — second pass

**Approx. 125 pages · R (soften later if needed) · Upstate New York and the Adirondacks**

**Tone:** cold and sparse for two hours, building to epic. Faith-forward moments live in characters' mouths, never in the film's voice.

**Logline:** After the Rapture leaves billions dead and the survivors convinced they've been damned, a broken contractor and a young woman build a settlement in the Adirondacks founded on never judging anyone — and when the new world comes to take it, they discover they were never left behind at all.
...
**2 ·** *(p.4)* Mid-lyric, Kayla stops singing. Then Tess. Neither is breathing. The car leaves the road.

**3 ·** *(p.6)* Emma and Ruthie crawl out. Nothing wrong with either of them. Nothing wrong with Kayla or Tess either — no wound, no blood, no reason. Emma keeps looking for a reason. She will keep looking for one for four years.

**4 ·** *(p.8)* A passenger jet comes down beyond the treeline. Then the sound of the world goes out. No engines. No planes. No horns. Birds.

**5 · INT. CHURCH, SCHENECTADY — SAME MORNING** *(p.9)*
Mid-service. JOHN, 37, at the back, not singing, not belonging. He has a contracting company he's spent his adult life trying to make into something. Twice it's come within reach; twice a big loss has put him back at the bottom. The first was a man he trusted. The second was nobody at all — no villain, no lesson, nothing to learn. The second time, he'd already decided God had helped him get there. He is three weeks into that, and he is not here for comfort. He's here for an accounting.

Half the congregation goes down where they stand.

**6 ·** *(p.12)* Screaming. Phones that don't work. Somebody says the word — *rapture* — and somebody else notices the priest is still standing.

**7 ·** *(p.14)* John says the true thing. *If this is a judgment, and he's still here, what does that make him?* He means it as a question. It does not land as one.
...
**9 ·** *(p.17)* The room turns. John gets between them and fails. It is slow and clumsy and awful — ordinary people are terrible at this and it takes far too long. When it's over the priest is on the floor and forty people are looking at their hands.
...
**35 ·** The doctrine, in fragments, across a hundred broadcasts: *There was no judgment. You are not guilty. There is no one keeping score.* To a planet drowning in guilt this is mercy. It is also permission.
...
**42 · OUTSIDE** *(p.76)* Helen watches a broadcast go out and notices, for the first time, that she can't remember when he last slept.
...
**49 ·** *(p.90)* The lamp in the meeting hall they can't afford to keep burning. It doesn't go out. Remarked on once. Never again.

**50 · OUTSIDE — THE EMPTY ROOM** *(p.91)* Helen walks in on the President alone. The warmth is off. Not menace — *nothing.* He sits and idles like a machine. Then the door sounds and it switches back on, mid-sentence, perfect. She says nothing. Not then. Not ever. **She stays.**
...
*Four years without giving a single order, and the first one he gives is to protect the man who would rather be exiled than break the law that protects John.*

**62 ·** *(p.111)* It costs him. Half of Eden looks at him differently for the rest of the film. Delia is the one who defends him, which surprises everyone including her.
...
**72 ·** They come down like a Renaissance ceiling tearing loose — gold light with no source, anatomy that doesn't work, too many wings, faces that will not resolve no matter how long you look. And they are **fading at the edges, half somewhere else.**
...
**73 ·** The enemy sorts itself. The men who are only men break and run — **and are allowed to.** Nobody stops them. What stays standing doesn't run, and for the only time in the film, the enemy's true shape shows.

**74 ·** Hazel stands up out of the mud, fading at the edges, and she is **laughing.**

**75 ·** Then Ray. Then Delia. The dead get up and pick their rifles back up, and **the enemy's only remaining weapon stops working.**

**76 ·** Emma sees a girl in the host she buried four years ago. Ruthie has been there the whole time. She is not sorry and she is not ashamed and she has been **waiting.**
...
**80 ·** John beside her, not carrying anything, for the first time in the film.

**81 ·** And then they go. All of them. The field empties. The lamp is still burning.
