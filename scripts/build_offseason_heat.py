...
def build():
    ...
    article = (
        ...
        + (f'<p class="b">The week that says more is the second-hottest one, '
           ...
           f'months before any of that existed, and nothing to do with fantasy football. World news '
           f'&mdash; the Israel-Iran conflict, Trump &mdash; showed up in chat, someone pushed back '
           f'that it belonged in a different room, and what started as a scheduling objection turned '
           f'into a real political argument. Horse Collars, Still The Creamiest and Smoke Dragons '
           f'carried most of it, with The Machines and Pork Chop Express in and out; openly called '
           f'&ldquo;an altercation&rdquo; by one of the managers watching it happen, it pulled in half '
           f'the league before it burned out. The record was going to have a hot week regardless of '
           f'whether anyone was keeping score &mdash; it just wasn&rsquo;t going to be about a trade.</p>'
           if second else '')
